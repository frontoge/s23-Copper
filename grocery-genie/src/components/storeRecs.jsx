...
const storeList = [
    ...
    {id: 2, name:'Kroger', image:kroger, location : 6.5, price:101, in_stock: 10, cname:"KrogerPic",link: 'https://www.kroger.com/pr/pickup-delivery-savings-4?ds_rl=1281562&ds_rl=1281680&cid=ps_adw_ogs_15x1savoffer_t:krogerclick&gclid=CjwKCAjwrpOiBhBVEiwA_473dFDZrwW3aTGjQaQwviSQy7rjNQwTiJkl1vDpK0YPb9cE5A0d8EM16xoCN20QAvD_BwE&gclsrc=aw.ds'},
    {id: 3, name:'Aldi', image: aldi, location: 1.7, price:99, in_stock: 9,cname:"AldiPic",link: 'https://www.aldi.us/?utm_source=google&utm_medium=sem&utm_campaign=brand&utm_term=aldi&gclid=CjwKCAjwrpOiBhBVEiwA_473dMx0IJIjK0_ys11If1jVm80YPOLbXhfDPAlyt26YwahkrRHvkiCNfRoCtAgQAvD_BwE&gclsrc=aw.ds'},
    {id: 4, name: 'Target', image: target, location: 8.4, price: 120, in_stock: 17,cname:"targetPic",link: 'https://www.target.com/c/grocery/-/N-5xt1a'},
    {id: 5, name: 'Food Lion', image:foodlion, location: 1.1, price: 99.80, in_stock: 15, cname:"foodlionPic",link: 'https://stores.foodlion.com/va/norfolk/2401-colley-ave' }
    ];
let s = [];
  ...
  /*  function totalPrice(){
    ...
    {data.map(store => (
        <div key={store.id} className="Store" >
          ...
          <h2>{`${store.name}`}</h2> 
          <p>{`location: ${store.location} mi`}</p>
